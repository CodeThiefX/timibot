...
print (re+" Telegram Adder")

print (gr+"version : 1.01")
print (cy+"Creator: Adesiyan Promise")
...
print ("3. Add only 50 members in group each time you run the code otherwise you will get flood error.")
